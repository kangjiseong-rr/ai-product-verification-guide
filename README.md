# AI 제품 및 서비스 확인제 기업용 가이드라인 <small>(2026. 07. 21.)</small>

{% hint style="danger" %}
본 가이드라인은 AI 제품 및 서비스 확인제 준비를 돕기 위한 참고 자료 로 작성되었습니다 . 안내된 내용은 어떠한 법적 효력도 가지지 않으며, 이를 활용한 결과에 대해 본 기관은 법적 책임을 지지 않습니다.<br>
확인 기준에 대해 궁금한 점이나 개선사항이 있는 경우 「인공지능 제품ㆍ서비스 확인제도 신청시스템」(aiverify.kr) 을 통해 문의하여 주시기 바랍니다.
{% endhint %}
